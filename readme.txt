...
**Do you have sample code for sending an email?**
See the fantastic Swift Mailer documentation http://swiftmailer.org/docs/sending.html

**Where do the library files come from?**
All lib files are pulled directly from the official Swift Mailer github repo at https://github.com/swiftmailer/swiftmailer
...
== Changelog ==
= 5.4.3 =
* Updated to Swift Mailer library v5.4.3
* Confirmed compatibility with WordPress v4.5.3
